...
mkdir -p "$OUT_DIR"
runsim proto_test1.exe -c
runsim proto_test2.exe -c
runsim proto_test3.exe -c
runsim proto_test4.exe -c
runsim proto_test5.exe -c
runsim proto_test6.exe -c
runsim proto_test7.exe -c
